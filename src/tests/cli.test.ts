...
describe('CLI Commands', () => {
  ...
  test(
    'check command should validate safety and show output',
    async () => {
  ...
  test(
    'check command should detect duplicates across multiple calls',
    async () => {
      // Clear history first
      detectionEngine.clear();
  ...
  test(
    'report command should show accumulated statistics',
    async () => {
  ...
  test(
    'blocked command should show block log',
    async () => {
